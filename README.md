...
- [Zappa - Run a Python WSGI app on AWS Lambda + API Gateway](git@github.com:pzelnip/awesome-lambda.git) - Python - less a lambda example and more a cool idea for tech that uses Lambda
